...
export function ThreadView({ messages, viewerSlug, now, agentName }: ThreadViewProps) {
  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-10 text-center text-slate-500 sm:px-6 sm:py-12">
        <div className="mb-3 text-4xl">👋</div>
        <div className="mb-1 text-base font-medium text-slate-700 sm:text-lg">
